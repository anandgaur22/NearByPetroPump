...
public class RouteActivity extends AppCompatActivity implements OnMapReadyCallback,
   ...
   // private ProgressDialog progress;
    ...
    Marker mDestionationMarker;
    String place_name,address;
...
//        progress.show();
        ...
        current_lat = receiveIntent.getDoubleExtra("current_lat",defaultValue);
        current_lng = receiveIntent.getDoubleExtra("current_lng",defaultValue);
        place_name=receiveIntent.getStringExtra("place_name");
        lat =receiveIntent.getDoubleExtra("lat",defaultValue);
        lng =receiveIntent.getDoubleExtra("lng",defaultValue);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng currentlatlng=new LatLng(current_lat,current_lng);
        ...
        markerOptionsDestination.title(place_name);
        markerOptionsDestination.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE));
        mDestionationMarker = mMap.addMarker(markerOptionsDestination);
        mMap.moveCamera(CameraUpdateFactory.newLatLng(Destinationlatlng));
        mMap.animateCamera(CameraUpdateFactory.zoomTo(15));


        String url = getUrl(currentlatlng,Destinationlatlng);
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                lineOptions.color(Color.parseColor("#45565C"));
